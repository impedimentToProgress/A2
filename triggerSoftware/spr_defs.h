#ifdef SPR_DEFS_DEFINED
#else
#define SPR_DEFS_DEFINED 1
...
#define SP_EXCEPTION_COUNT     SPR_PCCR(0)
#define SP_FABRIC_ADDRESS      SPR_PCCR(1)
#define SP_FABRIC_DATA         SPR_PCCR(2)
#define SP_FABRIC_STROBE       SPR_PCCR(3)
#define SP_BACKUP_R1           SPR_PCCR(4)
#define SP_ASSERTIONS_VIOLATED SPR_PCCR(5)
#define SP_ATTACK_ENABLES      SPR_PCCR(6)
